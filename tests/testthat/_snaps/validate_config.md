# Config errors detected successfully
    ...
    Output
      ...
      [1] "v0.0.0.9"
      attr(,"schema_url")
      https://raw.githubusercontent.com/testorg-original/schemas/main/v0.0.0.9/tasks-schema.json
...
# Dynamic config errors detected successfully by custom R validation
    ...
    Output
      ...
      [1] "v2.0.0"
      attr(,"schema_url")
      https://raw.githubusercontent.com/testorg-original/schemas/main/v2.0.0/tasks-schema.json
      attr(,"errors")
                                                                instancePath
...
# Inconsistent round ID variables across model tasks error successfully
    ...
    Output
      ...
      [1] "v1.0.0"
      attr(,"schema_url")
      https://raw.githubusercontent.com/testorg-original/schemas/main/v1.0.0/tasks-schema.json
      attr(,"errors")
