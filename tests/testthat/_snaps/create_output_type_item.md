...
---
    ...
    Output
      ...
      [1] "output_type_item" "list"            
      attr(,"schema_id")
      [1] "https://raw.githubusercontent.com/testorg-original/schemas/main/v1.0.0/tasks-schema.json"
...
# create_output_type_dist functions creates expected warnings
    ...
    Condition
      ...
      ! Cannot determine appropriate type for argument `value_minimum`, type validation skipped.  Schema may be invalid. Consult relevant schema and consider opening an issue at <https://github.com/testorg-original/schemas/issues>
      Warning in `create_output_type_sample()`:
      ! Cannot determine appropriate type for argument `value_maximum`, type validation skipped.  Schema may be invalid. Consult relevant schema and consider opening an issue at <https://github.com/testorg-original/schemas/issues>
    Output
      $sample
      $sample$output_type_id
      $sample$output_type_id$required
