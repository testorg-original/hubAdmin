...
The first step to setting up a Modeling Hub is to make a copy of the [`hubTemplate`](https://github.com/testorg-rename/hubTemplate) GitHub template repository and clone a local copy of it.
...
For more details on these files, guidance on how to set them up and access to templates, please see our central [**hubDocs**](https://github.com/testorg-rename/hubDocs) as well the [JSON schema](https://github.com/testorg-rename/schemas) the config files should adhere to.
